...
using DotnetMsSqlMRA.Api.Filters;
using DotnetMsSqlMRA.Business.Installer;

namespace DotnetMsSqlMRA.Api.Installer
{
    public class APIInstaller
{
    ...
    public void Install()
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "DotnetMsSqlMRA API", Version = version + "-" + branch });
        });
