using DotnetMsSqlMRA.Api.Installer;
using DotnetMsSqlMRA.Api.Middleware;
using DotnetMsSqlMRA.Data.Repositories;
...
using System;
using DotnetMsSqlMRA.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;

namespace DotnetMsSqlMRA.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "DotnetMsSqlMRA V1");
        });
